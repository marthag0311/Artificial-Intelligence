...
namespace _10_Instagram_s_Image_Recognition
{
    //Why use static?
    //Utility Class: It seems like the Matrix class is
    //designed to be a utility class for performing
    //operations on matrices. In such cases, it's common
    //to make the methods static to avoid the need to
    //create an instance of the class to use these methods.
    class Matrix
    {
