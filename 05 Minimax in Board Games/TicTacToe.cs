...
namespace _05_Minimax_in_Board_Games
{
    class TicTacToe
    {
        char[] board;
        ...
        // Naive - random player
        //add a naive opponent to your Tic Tac Toe class
        //a naive player is a player who just picks a random open place
        ...
        public int SmartPlayer()
        {
            ...
            foreach (int position in EmptyPlaces())
            {
                ...
                board[position] = 'O'; // place the character in that place
        ...
        private int MinMax(bool isMax)
        {
            ...
            if (isMax)
            {
                ...
                {
                    char digit = board[position];
                    board[position] = 'X'; // place the character in that place
